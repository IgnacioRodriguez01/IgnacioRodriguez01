export default function Contact({lang}) {
    ...
    const textContactES = {
        ...
        subject:"Contacto%20desde%20portafolio",
        mwl:"hecho con ♥ por Nacho"
    }
    const textContactEN = {
        title:"Contact",
        subtitle:"Get in touch:",
        subject:"Contact%20from%20portfolio",
        mwl:"made with ♥ by Nacho"
    }

    let textLang = lang === "EN" ? textContactEN : textContactES;

    return(
        <div className="contact" id='4'>
            <h3>{textLang.title}</h3>
            <p>{textLang.subtitle}</p>
            <a href={`mailto:ignacioandresrodriguez01@gmail.com?subject=${textLang.subject}`} target="_blank">
                ...
                ignacioandresrodriguez01@gmail.com
            </a>
            <a href="https://github.com/IgnacioRodriguez01" target="_blank">
                <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://www.linkedin.com/in/ignacio-andres-rodr%C3%ADguez/" target="_blank">
                <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
